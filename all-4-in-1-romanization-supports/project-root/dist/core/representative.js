...
exports.defaultRepresentativeSource = exports.InMemoryRepresentativeIndex = void 0;
exports.mapRowToEntry = mapRowToEntry;
exports.loadRepresentativeRules = loadRepresentativeRules;
exports.loadDefaultRepresentativeIndex = loadDefaultRepresentativeIndex;
/**
 ...
 */
class InMemoryRepresentativeIndex {
    byInput = new Map();
    /**
...
exports.InMemoryRepresentativeIndex = InMemoryRepresentativeIndex;
/**
 ...
 */
function loadRepresentativeRules(source, options = {}) {
    ...
    const entries = filteredRows.map((row) => mapRowToEntry(row));
 ...
 */
exports.defaultRepresentativeSource = {
    rows: [
        {
            category: 'V',
            input: 'tou',
 ...
 */
function loadDefaultRepresentativeIndex() {
    return loadRepresentativeRules(exports.defaultRepresentativeSource, {
        filter: 'all',
    });
}
