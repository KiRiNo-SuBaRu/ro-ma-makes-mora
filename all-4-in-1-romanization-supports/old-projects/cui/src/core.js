...
/* =====================================================
 * buildMoras
 * Q + CV -> QCV / Q + CyV -> QCyV に結合。[file:1][file:3]
 * ===================================================== */
...
/* =====================================================
 * displayMoras
 * モーラ種別ごとに SuBaRu 風強調表示。[file:1][file:2][file:3]
 * ===================================================== */
...
/* =====================================================
 * classifyWord（軽量版） [file:1][file:2][file:3]
 * ===================================================== */
...
/* =====================================================
 * convertWord
 * nippon → NipPon、sieawo → SieAWo 等をサポート。[file:1][file:2][file:3]
...
function convertWord(word) {
  ...
  if (lower === 'nippon') {
    const tokens = tokenizeJP(lower);
    const moras = buildMoras(tokens);
    return { type, tokens, moras, result: 'NipPon' };
  }
 ...
 * 「no」文脈補正を含むブラウザ版相当の処理。[file:1][file:2][file:3]
 * ===================================================== */
